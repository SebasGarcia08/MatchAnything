...
def draw_matches_core(
    ...
    """
    alpha =dynamic_alpha(len(mkpts0), milestones=[0, 200, 500, 1000, 2000, 4000], alphas=[1.0, 0.5, 0.3, 0.2, 0.1, 0.07])
    color = error_colormap(np.zeros((len(conf),)), 1e-4, alpha=alpha)
