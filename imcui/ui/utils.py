...
def gen_examples():
    ...
    # image pair path
    images_dir = ROOT / "datasets/multi_modality_pairs"
    pairs_homo = [
        [str(images_dir / "ct_mr_1.png"), str(images_dir / "ct_mr_2.png")],
        [str(images_dir / "thermal_vis_1.jpg"), str(images_dir / "thermal_vis_2.jpg")],
        [str(images_dir / "vis_map_1.jpg"), str(images_dir / "vis_map_2.jpg")],
        [str(images_dir / "vis_map_pair2_1.jpg"), str(images_dir / "vis_map_pair2_2.jpg")],
    ]

    pairs_fund = [
        [str(images_dir / "vis_event_1.png"), str(images_dir / "vis_event_2.png")],
        [str(images_dir / "vis_thermal_ground_1.png"), str(images_dir / "vis_thermal_ground_2.png")],
        [str(images_dir / "MTV_thermal_vis_1.jpg"), str(images_dir / "MTV_thermal_vis_2.jpg")],
    ...
    dist_examples = distribute_elements(pairs_fund, example_matchers)
    for pair, mt in zip(pairs_fund, dist_examples):
        input_lists.append(
            [
                pair[0],
                pair[1],
